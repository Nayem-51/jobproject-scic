...
export default function Footer() {
  return (
    <footer className="api-footer bg-gray-900 text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">ShopNow</h3>
            <p className="text-gray-400">
              Your trusted online shopping destination. Quality products, fast shipping, and exceptional service.
            </p>
          </div>
          <div>
            <h4 className="text-lg font-semibold mb-4">Shop</h4>
            <ul className="space-y-2 text-gray-400">
              <li><a href="/items" className="hover:text-white transition">All Products</a></li>
